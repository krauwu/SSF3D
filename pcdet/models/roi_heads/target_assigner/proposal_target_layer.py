...
class ProposalTargetLayer(nn.Module):
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        """
        # roi scores are the topk scores of cls_pred, and the roi labels are the corresponding labels
        ...
        for index in range(batch_size):
            ...
            if self.roi_sampler_cfg.get('SAMPLE_ROI_BY_EACH_CLASS', False):
                max_overlaps, gt_assignment = self.get_max_iou_with_same_class(            #get iou with max overlaped gt, and gt index
