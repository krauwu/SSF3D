...
class PointHeadSimple(PointHeadTemplate):
    ...
    def forward(self, batch_dict):
        ...
        if batch_dict['teacher_point_head_cls'] is not None:
            ret_dict['teacher_point_head_cls'] = batch_dict['teacher_point_head_cls']
        batch_dict['teacher_point_head_cls'] = point_cls_preds.view(-1, self.num_class).float()
        ...
        if self.training:
            ...
            ret_dict['labeled_frame'] = batch_dict['labeled_frame']
